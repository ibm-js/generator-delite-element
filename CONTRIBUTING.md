...
```bash
$ git clone git@github.com:username/generator-delite-element.git
```

This will clone your fork to your current path in a directory named `generator-delite-element`.
...
```bash
$ cd generator-delite-element
$ git remote add upstream git@github.com:ibm-js/generator-delite-element.git
$ git fetch upstream
```
